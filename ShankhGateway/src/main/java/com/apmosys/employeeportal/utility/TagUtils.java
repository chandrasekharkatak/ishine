...
public class TagUtils {
	...
	// if (tagDTO.getProjectId() == null || projectText == null ||
	// projectText.isEmpty()) {
	...
	// List<TagMaster> existingTags =
	// tagMasterRepository.findByEntityIdAndEntityType(tagDTO.getEntityId(),
	// tagDTO.getEntityType());
	...
	// public ServiceResponse sendFileForOCR(MultipartFile document, Long entityId,
	// String entityName, Long questionMasterId, Long projectId) {
	// ServiceResponse response = new ServiceResponse();
	// try {
	// if (document != null) {
	...
	// String syncResponse = restTemplate.postForObject(dmsPortalUploadUrl,
