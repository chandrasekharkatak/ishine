...
export class LoaderInterceptor implements HttpInterceptor {
  ...
  URL_whiteList = [
    ...
    `${this.baseUrl}api/getHotelSubCategoryByCategory`,
    `${this.baseUrl}api/getCitiesByHotelSubCategoryId`,
    ...
    `${this.baseUrl}` + `api/getReimbursementSubmissionSettings`,
    `${this.baseUrl}` + `api/saveReimbursementSubmissionSettings`,
    `${this.baseUrl}` + `api/getReimbursementSubmissionWindowStatus`,
    `${this.baseUrl}` + `api/getAllReimbursementApprovalMatrices`,
    `${this.baseUrl}` + `api/resolveReimbursementApprovalMatrixForEmployee`,
    `${this.baseUrl}` + `api/saveAllReimbursementApprovalMatrices`,
    `${this.baseUrl}` + `api/saveReimbursementApprovalMatrix`,
    `${this.baseUrl}` + `api/deleteReimbursementApprovalMatrix`,
    `${this.baseUrl}` + `api/listAllReimbursementRolePolicies`,
    `${this.baseUrl}` + `api/fetchReimbursementRolePolicy`,
    `${this.baseUrl}` + `api/saveReimbursementRolePolicy`,
    `${this.baseUrl}` + `api/deleteReimbursementRolePolicy`,
    `${this.baseUrl}` + `api/resolveReimbursementRolePolicyForEmployee`,
    `${this.baseUrl}` + `api/getAllTravelApprovalMatrices`,
    `${this.baseUrl}` + `api/resolveTravelApprovalMatrixForEmployee`,
    `${this.baseUrl}` + `api/saveTravelApprovalMatrix`,
    `${this.baseUrl}` + `api/deleteTravelApprovalMatrix`,
    `${this.baseUrl}` + `api/saveTravelDeskTicket`,
    `${this.baseUrl}` + `api/fetchMyTravelDeskTickets`,
    `${this.baseUrl}` + `api/fetchTravelDeskTicketsForApproval`,
    `${this.baseUrl}` + `api/fetchTravelDeskTicketsAssignedAll`,
    `${this.baseUrl}` + `api/processTravelDeskTicketApproval`,
    `${this.baseUrl}` + `api/resolveTravelApprovalMatrixForEmployee`,
    `${this.baseUrl}`+`api/deleteExpenditureType`,
    `${this.baseUrl}`+`api/deleteReimbursementTravelMode`,
    `${this.baseUrl}`+`api/deleteVehicleType`,
    `${this.baseUrl}`+`api/deleteFoodType`,
    ...
    `${this.baseUrl}` + `api/getEmployeeTimesheetAsCalender`,
    ...
    `${this.baseUrl}` + `api/updateNotification`,
    `${this.baseUrl}` + `api/submitNotificationConsent`
  ]
