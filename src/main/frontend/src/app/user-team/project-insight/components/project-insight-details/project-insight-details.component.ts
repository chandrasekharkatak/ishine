...
import { LeftSideMenuComponent, ProjectTableComponent } from '..';
...
export class ProjectInsightDetailsComponent implements OnInit {
  ...
  navigateToChild(routeTo: string) {
    ...
    switch (routeTo) {
      ...
      case 'question-library':
        ...
        break;
      case 'project-insight-details':
        this.showTable();
        break;
    }
    this.router.navigate([routeTo], { relativeTo: routeTo == 'project-insight-details' ? this.route.parent : this.route });
  }
