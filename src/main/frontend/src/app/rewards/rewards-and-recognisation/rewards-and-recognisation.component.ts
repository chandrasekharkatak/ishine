 ...
 bulkEnableQuarter(template: TemplateRef<any>) {
  ...
  downloadRewardFileTemplatee(): void {
    ...
    const headers = [
      ...
      ['e.g. A-240017/APR-240017', 'e.g. Prarthana Lenka', 'e.g. Monthly/Half Yearly/Annual/Quarterly', 'e.g. Gem Of The Month', 'e.g. January 2025/Q2 2025(For Quarterly)', 'e.g. Did their best in their respective fields']
    ];
