...
//				+ "        LEFT JOIN Holidays_In_Range h ON adir.dt = h.date_of_holiday\n"
		...
		@Query(value=" WITH RECURSIVE\n"
				...
				+ "                COALESCE(dsc.Ready_for_invoicing,0) as 'Ready_For_invoicing'\n"
				+ "				,bpe.active"
				+ "				FROM\n"
				+ "				Base_Project_Employees bpe\n"
				+ "				LEFT JOIN\n"
				...
				+ "				bpe.reporting_manager_id,\n"
				+ "				wds.expected_fill_count, eds.pending_days, eds.approved_days,bpe.employement_id,\n"
				+ "				dsc.Present, dsc.WeekOff, dsc.Holiday, dsc.Leave, dsc.Comp_Off, dsc.NA_Count, dsc.Half_Day,dsc.Ready_For_invoicing,bpe.employmentstatus, bpe.end_date\n"
