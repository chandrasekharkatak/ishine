...
//				+ "        LEFT JOIN Holidays_In_Range h ON adir.dt = h.date_of_holiday\n"
		...
		@Query(value="WITH RECURSIVE\n"
				...
				+ "            WHEN doc_approved.timesheet_id IS NOT NULL THEN 'DA'\n"
				+ "            WHEN doc_pending.timesheet_id IS NOT NULL THEN 'DP'\n"
				...
				+ "    bpe.employement_id,\n"
				+ "    SUM(CASE WHEN dsd.daily_status IN ('DA', 'DP', 'P') THEN 1 ELSE 0 END) AS 'Present',\n"
				...
				+ "    0 AS 'Half_Day',\n"
				+ "    SUM(CASE WHEN dsd.daily_status IN ('DA','DP','P','WO','AH','CH','L','A','O') THEN 1 ELSE 0 END) AS total_days,\n"
	...
	@Query(value=" WITH RECURSIVE\n"
			...
			+ "    SUM(CASE WHEN dsd.daily_status IN ('AH', 'CH') THEN 1 ELSE 0 END) AS 'Holiday',\n"
			+ "    SUM(CASE WHEN dsd.daily_status = 'L' THEN 1 ELSE 0 END) AS 'Leave',\n"
			+ "    SUM(CASE WHEN dsd.daily_status IN ('A','O','NA') THEN 1 ELSE 0 END) AS 'NA_Count',\n"
			+ "    0 AS 'Comp_Off', 0 AS 'Half_Day',\n"
