...
//				+ "                                       WHEN h.date_of_holiday IS NOT NULL AND h.holiday_type NOT LIKE '%Week Off%' THEgetEmployeeViewForClientAttendanceStatusN 'H'\n"
				+ "				                ELSE 'A'\n"
				+ "				            END AS daily_status\n"
				+ "				        FROM Base_Project_Employees bpe\n"
				+ "				        CROSS JOIN All_Dates_In_Range adir\n"
