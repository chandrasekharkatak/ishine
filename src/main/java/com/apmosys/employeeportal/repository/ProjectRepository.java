...
public List<Project> findProjectsOfProjectManager(Long projectManagerId);
	...
	@Query(nativeQuery=true,value="WITH RECURSIVE\n"
			...
			+ "     (wds.expected_fill_count - (IFNULL(ds.Client_pending_count, 0)\n"
			+ "     + IFNULL(ds.Client_Approved_count, 0))) as client_side_not_filled_count,\n"
			...
			+ "ORDER BY\n"
			+ "    bpe.name, vwd.dt")
	public Optional<List<Object[]>> getEmployeeViewForClientAttendanceStatus(
