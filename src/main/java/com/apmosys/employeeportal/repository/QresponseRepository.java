...
public interface QresponseRepository extends JpaRepository<Qresponse, Long> {
	...
	@Query(nativeQuery = true, value = "select * from qresponse where emp_id = :empId and quarter_id = :quarterId")
	public List<Qresponse> findempId(@Param("empId") Long empId,@Param("quarterId") Long quarterId);
